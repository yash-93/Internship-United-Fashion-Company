...
<!-- Background -->
	<section class="container text-center aboutcompany">
		<div class="row frow">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-10 d-block m-auto">
				<h1 data-aos="fade-down">United Fashion Company Ltd., Co.</h1>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-12 col-10 d-block m-auto">
				<hr>
			</div>
		...
		<div class="row trow">
			<div class="col-lg-5 col-md-5 col-sm-10 col-10 d-block mr-auto">
				<hr>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12 col-10 d-block mr-auto" data-aos="zoom-in">
				<label>Minray products mainly provides the following services:</label>
			</div>
		</div>
		<div class="row frrow">
			<div class="col-lg-4 col-md-4 col-sm-12 col-10 d-block mr-auto">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-10 d-block m-auto" data-aos="fade-left" data-aos-duration="500">
				<ul>
					...
					<li>Customized purses for ladies</li><br>
					<li>Freaky wallet for men</li><br>
					<li>Pouches, Clutches for models</li>
				</ul>
			</div>
		</div>
		<div class="row fvrow">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-10 d-block mr-auto">
				<label  data-aos="zoom-in">3T service mode:</label>
			</div>
		</div>
		<div class="row sxrow">
			<div class="col-lg-4 col-md-4 col-sm-12 col-10 d-block mr-auto">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-10 d-block m-auto" data-aos="fade-left" data-aos-duration="500">
				<ul>
					...
					<li>Competitive Costs (COST): We only charge reasonable fees and give competitive prices to our clients</li>
				</ul>
			</div>
		</div>
		<div class="row svnrow">
			<div class="col-lg-4 col-md-4 col-sm-6 col-6 d-block m-auto">
				<button type="button" class="btn text-white" data-aos="fade-up" data-aos-duration="500">Get Your Bag Now</button>
			</div>
		</div>
	</section>
	...
	<section class="bg-light">
		<div class="container contact">
			<div class="row">
				<div class="col-lg-5 col-md-4 col-sm-12 col-10 d-block m-auto">
					<hr>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-12 col-10 d-block m-auto text-center" data-aos="fade-down" data-aos-duration="500">
					<h1>Contact Us</h1>
				</div>
				<div class="col-lg-5 col-md-4 col-sm-12 col-10 d-block m-auto">
					<hr>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-10 map">
					
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 col-10 aboutform">
					<form>
