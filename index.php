<?php 
	...
	$username = "id10797651_root";
	$password = "17097d54";
	$dbname = "id10797651_ufc_test";
...
<!-- NAVBAR -->
	<div class="bgimg">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse text-center" id="collapsenavbar" >
					<ul class="navbar-nav ml-auto" data-aos="fade-down-left" data-aos-duration="1000">
						...
						<li class="nav-item">
							<a href="#!" data-toggle="modal" data-target="#exampleModal" class="nav-link text-white" >LOG IN</a>
						</li>
					</ul>		
				</div>
			</div>
		...
		<div class="container text-center headerset text-white">
			<h2 data-aos="zoom-in" data-aos-duration="1000">Lorem Ipsum is simply dummy text</h2>
			<h1 data-aos="zoom-in" data-aos-duration="1000">Standard dummy text ever since the 1500s</h1>
...
<!-- CUSTOM RANGE -->
	...
	<section class="container text-center customrange">
		...
		<p data-aos="flip-down" data-aos-duration="1500">Shenzhen Minray Products Co., Ltd. is a service-oriented manufacturer and wholesaler of Duffle, Travel, Tote, Cooler, Solar, Tool Bags and Backpacks. We are committed to providing a high-quality supply platform for all kinds of customers</p>
